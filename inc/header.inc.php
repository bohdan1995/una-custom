...
define('BX_DOL_URL_ROOT', 'http://localhost/una-test/'); ///< site url

define('BX_DIRECTORY_PATH_ROOT', 'E:/programs/xampp/htdocs/una-test/'); ///< site path
...
define('BX_DATABASE_NAME', 'una-test'); ///< db name
define('BX_DATABASE_ENGINE', 'MYISAM'); ///< db engine

define('BX_SYSTEM_JAVA', ''); ///< path to java binary
define('BX_SYSTEM_FFMPEG', 'E:/programs/xampp/htdocs/una-test/plugins/ffmpeg/ffmpeg.exe'); ///< path to ffmpeg binary
define('BX_DOL_SECRET', 'BShU!iXfYyD'); ///< secret word
