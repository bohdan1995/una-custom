...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
    <head>
        ...
        <script defer language="javascript">
            var sUrlStudio = 'http://localhost/una-test/studio/';
        </script>
...
<div class="bx-std-content-wrp bx-std-pc-stretch">
    <script defer language="javascript">
    <!--
    var oBxDolStudioPage = new BxDolStudioPage({
        sActionUrl: 'http://localhost/una-test/studio/ajax.php'
    });
    -->
    </script>
    <?php echo $a['page_caption_code'];?>
    <div class="bx-std-page-columns bx-std-pc-stretch" id="bx-std-page-columns" <?php echo $a['page_attributes'];?>>
    ...
    <div class="bx-std-page-column bx-std-page-content bx-std-pc-stretch">
        <div class="bx-std-page-column-cnt bx-def-padding-rightbottomleft bx-def-box-sizing" id="bx-std-pc-content"><?php echo $a['page_main_code'];?></div>
    </div>
</div>
    </div>
</div>
