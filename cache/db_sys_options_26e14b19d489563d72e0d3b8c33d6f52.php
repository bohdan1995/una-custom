<?php $mixedData=array (
  ...
  'sys_session_lifetime_in_min' => '129600',
  'sys_account_activation_letter' => '',
  'sys_logs_storage_default' => 'Folder',
  'sys_default_curl_timeout' => '300',
...
<script>
  ...
  'sys_oauth_key' => 'bhqbgmuedp',
  'sys_oauth_secret' => 'yhnt5dllgtqqfa3pnz2cqxv6htzcwjnl',
  'currency_code' => 'USD',
  'currency_sign' => '&#36;',
  'client_image_resize_width' => '0',
  'client_image_resize_height' => '0',
  'useLikeOperator' => 'on',
  'sys_default_payment' => '',
  'sys_embed_default' => '',
  'sys_embedly_api_key' => '',
  ...
  'sys_add_nofollow' => 'on',
  'sys_security_block_content_after_n_reports' => '0',
  'site_title' => 'The Test Una',
  'site_email' => 'edithjenkins1992@gmail.com',
  'site_email_notify' => 'edithjenkins1992@gmail.com',
  'site_tour_home' => 'on',
  'site_tour_studio' => 'on',
  ...
  'sys_account_reset_password_key_lifetime' => '259200',
  'sys_account_reset_password_redirect' => 'home',
  'sys_account_reset_password_redirect_custom' => '',
  'sys_account_disable_login_form' => '',
  'sys_account_disable_join_form' => '',
  'sys_account_allow_plus_in_email' => 'on',
  ...
  'sys_location_field_default' => 'sys_plain',
  'sys_location_map_default' => 'sys_leaflet',
  'sys_location_map_zoom_default' => '7',
  'sys_maps_api_key' => '',
  'sys_nominatim_server' => 'https://nominatim.openstreetmap.org',
  'sys_nominatim_email' => '',
  'sys_location_leaflet_provider' => 'OpenStreetMap.Mapnik',
  'sys_audit_enable' => '',
  'sys_audit_max_records' => '10000',
  'sys_audit_days_before_expire' => '365',
  'sys_audit_acl_levels' => '7,8',
  ...
  'bx_protean_block_title_padding' => '0.75rem 1.0rem 0.75rem 1.0rem',
  ...
  'bx_protean_button_lg_bg_color' => 'rgba(228, 233, 242, 1.0)',
  'bx_protean_button_lg_bg_color_hover' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_lg_bg_color_click' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_lg_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lg_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lg_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lg_border_size' => '0px',
  'bx_protean_button_lg_border_radius' => '4px',
  ...
  'bx_protean_button_lg_font_color' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_lg_font_color_hover' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_lg_font_color_click' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_lg_font_shadow' => 'none',
  'bx_protean_button_lg_font_weight' => '700',
  'bx_protean_button_lgp_height' => '2rem',
  'bx_protean_button_lgp_bg_color' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_lgp_bg_color_hover' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_lgp_bg_color_click' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_lgp_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_border_size' => '0px',
  'bx_protean_button_lgp_border_radius' => '4px',
  'bx_protean_button_lgp_shadow' => '0px 0px 0px 1px rgba(0,0,0,0.0)',
  'bx_protean_button_lgp_font_family' => 'Arial, sans-serif',
  'bx_protean_button_lgp_font_size' => '1rem',
  'bx_protean_button_lgp_font_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_font_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_font_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_lgp_font_shadow' => 'none',
  'bx_protean_button_lgp_font_weight' => '700',
  'bx_protean_button_nl_height' => '2rem',
  'bx_protean_button_nl_bg_color' => 'rgba(228, 233, 242, 1.0)',
  'bx_protean_button_nl_bg_color_hover' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_nl_bg_color_click' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_nl_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nl_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nl_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nl_border_size' => '0px',
  'bx_protean_button_nl_border_radius' => '4px',
  'bx_protean_button_nl_shadow' => '0px 0px 0px 1px rgba(0,0,0,0.0)',
  'bx_protean_button_nl_font_family' => 'Arial, sans-serif',
  'bx_protean_button_nl_font_size' => '0.75rem',
  'bx_protean_button_nl_font_color' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_nl_font_color_hover' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_nl_font_color_click' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_nl_font_shadow' => 'none',
  'bx_protean_button_nl_font_weight' => '600',
  'bx_protean_button_nlp_height' => '2rem',
  'bx_protean_button_nlp_bg_color' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_nlp_bg_color_hover' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_nlp_bg_color_click' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_nlp_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_border_size' => '0px',
  'bx_protean_button_nlp_border_radius' => '4px',
  'bx_protean_button_nlp_shadow' => '0px 0px 0px 1px rgba(0,0,0,0.0)',
  'bx_protean_button_nlp_font_family' => 'Arial, sans-serif',
  'bx_protean_button_nlp_font_size' => '1rem',
  'bx_protean_button_nlp_font_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_font_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_font_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_nlp_font_shadow' => 'none',
  'bx_protean_button_nlp_font_weight' => '700',
  'bx_protean_button_sm_height' => '1.75rem',
  'bx_protean_button_sm_bg_color' => 'rgba(228, 233, 242, 1.0)',
  'bx_protean_button_sm_bg_color_hover' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_sm_bg_color_click' => 'rgba(197, 206, 224, 1)',
  'bx_protean_button_sm_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_sm_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_sm_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_sm_border_size' => '0px',
  'bx_protean_button_sm_border_radius' => '4px',
  ...
  'bx_protean_button_sm_font_color' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_sm_font_color_hover' => 'rgba(46, 56, 86, 1.0)',
  'bx_protean_button_sm_font_color_click' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_sm_font_shadow' => 'none',
  'bx_protean_button_sm_font_weight' => '400',
  'bx_protean_button_smp_height' => '1.75rem',
  'bx_protean_button_smp_bg_color' => 'rgba(51, 102, 255, 1.0)',
  'bx_protean_button_smp_bg_color_hover' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_smp_bg_color_click' => 'rgba(0, 87, 194, 1.0)',
  'bx_protean_button_smp_border_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_border_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_border_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_border_size' => '0px',
  'bx_protean_button_smp_border_radius' => '4px',
  'bx_protean_button_smp_shadow' => '0px 0px 0px 1px rgba(0,0,0,0)',
  'bx_protean_button_smp_font_family' => 'Arial, sans-serif',
  'bx_protean_button_smp_font_size' => '0.75rem',
  'bx_protean_button_smp_font_color' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_font_color_hover' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_font_color_click' => 'rgba(255, 255, 255, 1.0)',
  'bx_protean_button_smp_font_shadow' => 'none',
  'bx_protean_button_smp_font_weight' => '400',
  'bx_protean_font_family' => 'Arial, sans-serif',
  'bx_protean_font_size_default' => '16px',
  ...
  'bx_protean_font_size_large' => '20px',
