...
class BxBaseModGeneralModule extends BxDolModule
{
 ...
 /** 
     * @ref bx_base_general-entity_info_fullname "entity_info_fullname"
     */
	public function serviceEntityInfoFullName ($iContentId = 0)
    {
    	$CNF = &$this->_oConfig->CNF;

    	$sDisplayName = 'OBJECT_FORM_ENTRY_DISPLAY_VIEW_FULLNAME';
        return $this->_serviceEntityForm ('viewDataFormFullName', $iContentId, !empty($CNF[$sDisplayName]) ? $CNF[$sDisplayName] : false);
    }
    /**
     * @page service Service Calls
     * @section bx_base_general Base General
